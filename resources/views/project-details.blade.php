...
@section('title', 'Project Details - OYA')
...
@section('content')
    <div class="container">
        ...
        <!-- Display the detailed project card -->
        <div class="news-project-card">
            ...
            <div class="card-content">
                ...
                <p>
                    <!-- Additional content such as project status, start date, end date, etc. -->
                    <strong>Status:</strong> {{ ucfirst($project->status) }}<br>
                    <strong>Published At:</strong> {{ $project->published_at }}<br>
        ...
        <a href="{{ route('main.index') }}" class="back-button">Back to Projects</a>
    </div>
@endsection
